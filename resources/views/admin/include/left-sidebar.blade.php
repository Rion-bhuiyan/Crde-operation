...
{{--                    --}}
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('add.category')}}" class="slide-item">Add Category</a></li>
                        <li><a href= "{{route('manage.category')}}" class="slide-item">Manage Category</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="form-elements.html" class="slide-item">Add Blog</a></li>
                        <li><a href="form-layouts.html" class="slide-item">Manage Blog</a></li>
